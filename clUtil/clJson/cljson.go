...
func (js *JsonStream) ToFloat32() float32 {
	f, e := strconv.ParseFloat(js.ToStr(), 32)
	if e != nil {
		return 0
	}
	return float32(f)
...
func (js *JsonStream) ToFloat64() float64 {
	f, e := strconv.ParseFloat(js.ToStr(), 64)
	if e != nil {
		return 0
	}
	return f
...
func (js *JsonStream) ToInt32() int32 {
	i, e := strconv.ParseInt(js.ToStr(), 10, 32)
	if e != nil {
		return 0
	}
	return int32(i)
...
func (js *JsonStream) ToInt64() int64 {
	i, e := strconv.ParseInt(js.ToStr(), 10, 64)
	if e != nil {
		return 0
	}
	return int64(i)
...
func (js *JsonStream) GetStr(key string, subkey ...string) string {
	...
	finnaly := New([]byte(cacheVal))
	if finnaly == nil {
		return ""
	}
	return finnaly.ToStr()
}
